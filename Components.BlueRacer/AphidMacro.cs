...
namespace Components.BlueRacer
{
    ...
    //    public List<AphidExpression> Replace(IEnumerable<AphidExpression> values)
    //    {
    ...
    //        var kvps = values
    //            .Select((x, i) =>
    //                new KeyValuePair<string, AphidExpression>(Declaration.Args[i].Identifier, x))
    //            .ToDictionary(x => x.Key, x => x.Value);

    //        var replaced = new List<AphidExpression>();
    ...
    //    private AphidExpression Replace(Dictionary<string, AphidExpression> values, AphidExpression expression)
    //    {
